            ...
            <div className="content-group-articles">
                {group.articles.length === 0 ? (
                    ...
                    group.articles.map(article => (
                        <div key={article.id} className={`content-article-row ${selectedIds.includes(article.id) ? 'selected' : ''}`}>
                            ...
                            <div className="content-article-info">
                                <span className={`index-dot ${article.indexStatus === 'indexed' ? 'dot-green' : 'dot-gray'}`}></span>
                            ...
                            <div className="content-article-actions">
                                <button className="btn btn-sm btn-secondary" onClick={() => onMarkIndexed(group.id, article.id)} title="Mark Indexed">
